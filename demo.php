                      ...
                      <tr>
                        <td style="background:#fff; border-left: 1px solid #e1e1e1;border-right: 1px solid #e1e1e1;"><div mc:edit="std_content10">
                            <table border="0" cellpadding="0" cellspacing="0" width="698">
                              ...
                              <tr><td>&nbsp;</td></tr>
                                <tr>
                                  <td style="padding-top:10px; text-align:center" align="center" valign="top"><a target="_blank" href="' . $tconfig['tsite_url'] . '"><img src="' . $tconfig['tsite_img'] . '/menu-logo.png" align="none" border="0"></a></td>
                                </tr>
                              <tr><td>&nbsp;</td></tr>
                              <tr><td>&nbsp;</td></tr>
                              </tbody>
